...
public class Tab1Architecture extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //Firebase Database Reference for current day.
        ...
        dateRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                //Firebase Database Reference for today's architecture.
                DatabaseReference artRef = database.getReference("ArtWorks/ArtType/architecture/" + tempDaily.getArchitecture() + "/");
                Log.i(TAG, "DatabaseReference of Art, artRef is: " + artRef.toString());

                //Retrieving today's architecture's data.
                artRef.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        Art art = dataSnapshot.getValue(Art.class);
                        //Converting art's image URL to Bitmap.
                        Bitmap bitmap = loadImageFromWebOperations(art.getUrl());
                        //Setting view's values.
                        art_name.setText(tempDaily.getArchitecture());
    ...
    //Downloads Image from url and converts it to Bitmap.
            ...
            switch (view.getId())
            {
                case R.id.like_button:  {
                    ...
                    dateRef.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            final DailyPlan tempDaily = dataSnapshot.getValue(DailyPlan.class);
                            DatabaseReference likeRef = database.getReference("ArtWorks/ArtType/architecture/" + tempDaily.getArchitecture());
