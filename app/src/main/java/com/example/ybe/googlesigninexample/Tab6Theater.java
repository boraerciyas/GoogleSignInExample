...
public class Tab6Theater extends Fragment {
    ...
    private static final String TAG = "Tab6Theater";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.tab6_theater, container, false);
        ...
        dateRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                DatabaseReference artRef = database.getReference("ArtWorks/ArtType/theater/" + tempDaily.getTheater() + "/");
                ...
                artRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        art_name.setText(tempDaily.getTheater());
            ...
            switch (view.getId())
            {
                case R.id.like_button:  {
                    ...
                    dateRef.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            final DailyPlan tempDaily = dataSnapshot.getValue(DailyPlan.class);
                            DatabaseReference likeRef = database.getReference("ArtWorks/ArtType/theater/" + tempDaily.getTheater());
                ...
                case R.id.library_button:   {
                    ...
                    DatabaseReference libRef = database.getReference("ArtWorks/ArtType/theater/" + artName);
