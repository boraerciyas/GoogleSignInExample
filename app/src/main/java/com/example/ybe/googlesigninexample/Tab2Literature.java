...
public class Tab2Literature extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.tab2_literature, container, false);
        ...
        dateRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                //Firebase Database Reference for today's literature.
                DatabaseReference artRef = database.getReference("ArtWorks/ArtType/literature/" + tempDaily.getLiterature() + "/");
                ...
                artRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        art_name.setText(tempDaily.getLiterature());
            ...
            switch (view.getId())
            {
                case R.id.like_button:  {
                    ...
                    dateRef.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            final DailyPlan tempDaily = dataSnapshot.getValue(DailyPlan.class);
                            DatabaseReference likeRef = database.getReference("ArtWorks/ArtType/literature/" + tempDaily.getLiterature());
