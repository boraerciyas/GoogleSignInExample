...
public class Tab5Sculpture extends Fragment {
    ...
    private static final String TAG = "Tab5Sculpture";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.tab5_sculpture, container, false);
        ...
        dateRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                DatabaseReference artRef = database.getReference("ArtWorks/ArtType/sculpture/" + tempDaily.getSculpture() + "/");
                ...
                artRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        art_name.setText(tempDaily.getSculpture());
            ...
            switch (view.getId())
            {
                case R.id.like_button:  {
                    ...
                    dateRef.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            final DailyPlan tempDaily = dataSnapshot.getValue(DailyPlan.class);
                            DatabaseReference likeRef = database.getReference("ArtWorks/ArtType/sculpture/" + tempDaily.getSculpture());
                ...
                case R.id.library_button:   {
                    ...
                    DatabaseReference libRef = database.getReference("ArtWorks/ArtType/sculpture/" + artName);
