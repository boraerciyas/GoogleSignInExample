...
public class Tab3Music extends Fragment {
    ...
    private static final String TAG = "Tab3Music";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        dateRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                DatabaseReference artRef = database.getReference("ArtWorks/ArtType/music/" + tempDaily.getMusic() + "/");
                ...
                artRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        art_name.setText(tempDaily.getMusic());
            ...
            switch (view.getId())
            {
                case R.id.like_button:  {
                    ...
                    dateRef.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            final DailyPlan tempDaily = dataSnapshot.getValue(DailyPlan.class);
                            DatabaseReference likeRef = database.getReference("ArtWorks/ArtType/music/" + tempDaily.getMusic());
                ...
                case R.id.library_button:   {
                    ...
                    DatabaseReference libRef = database.getReference("ArtWorks/ArtType/music/" + artName);
